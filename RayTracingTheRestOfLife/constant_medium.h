...
public:
    constant_medium(shared_ptr<intersect> b, double d, shared_ptr<texture> a)
        : boundary(b),
        neg_inv_density(-1 / d),
        phase_function(make_shared<isotropic>(a))
    {}

    constant_medium(shared_ptr<intersect> b, double d, color c)
        : boundary(b),
        neg_inv_density(-1 / d),
